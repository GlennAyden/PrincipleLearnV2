-- Conservative backfill for feedback.origin_jurnal_id.
--
-- This only links legacy feedback mirrors to structured reflection journals
-- when the match is one-to-one across:
--   - user_id and course_id
--   - subtopic_id/subtopic_label/module_index/subtopic_index
--   - rating and comment payload
--   - created_at proximity within 5 minutes
--
-- Ambiguous pairs are intentionally left untouched.
