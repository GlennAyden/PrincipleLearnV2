...
REVOKE ALL ON FUNCTION public.ensure_leaf_subtopic(uuid, uuid, text, text, integer, integer) FROM PUBLIC, anon, authenticated;
...
REVOKE ALL ON FUNCTION public.insert_quiz_attempt(uuid, uuid, uuid, text, uuid, integer, integer, uuid, jsonb) FROM PUBLIC, anon, authenticated;
